...
## Description: 
This project involves cleaning and transforming [raw layoff data](layoffs.csv](https://github.com/user-attachments/files/19493768/layoffs.csv)) and analyzing the layoff data. The goal is to understand the impact and distribution of layoffs across different tech sectors during COVID-19 until present.
## SQL Skills Used: 
- Data Cleaning
-  Data Transformation
-  Data Type Conversion,
